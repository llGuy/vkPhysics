...
static inline SOCKET *get_network_socket(socket_t socket) {
...
static inline void s_set_socket_to_listening(socket_t s, uint32_t max_clients) {
    SOCKET *api_s = get_network_socket(s);
...
static inline int32_t s_receive_from(socket_t s, char *buffer, uint32_t buffer_size, address_t *address_dst) {
    SOCKET *sock = get_network_socket(s);
...
static inline bool s_send_to(socket_t s, address_t address, char *buffer, uint32_t buffer_size) {
    SOCKET *sock = get_network_socket(s);
...
static inline bool s_send_to_bound_address(socket_t s, char *buffer, uint32_t buffer_size) {
    SOCKET *sock = get_network_socket(s);
...
static inline int32_t s_receive_from_bound_address(socket_t s, char *buffer, uint32_t buffer_size) {
    SOCKET *sock = get_network_socket(s);
