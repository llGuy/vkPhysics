...
constexpr uint32_t MENU_WIDGET_NOT_HOVERED_OVER_ICON_COLOR = 0xFFFFFF90;
constexpr uint32_t MENU_WIDGET_LOCKED_BACKGROUND_COLOR = 0x09090990;
constexpr uint32_t MENU_WIDGET_LOCKED_ICON_COLOR = 0x09090990;
constexpr uint32_t MENU_WIDGET_NOT_HOVERED_OVER_BACKGROUND_COLOR = 0x16161690;
constexpr uint32_t MENU_WIDGET_HOVERED_OVER_ICON_COLOR = MENU_WIDGET_NOT_HOVERED_OVER_ICON_COLOR;
constexpr uint32_t MENU_WIDGET_HOVERED_OVER_BACKGROUND_COLOR = 0x76767690;
constexpr uint32_t MENU_WIDGET_CURRENT_MENU_BACKGROUND = 0x13131390;
