...
void main() {
    ...
    for (int i = 0; i < 3; ++i) {
        ...
        dude_vs_positions[i] = u_lighting_transforms.shadow_view * dude_ms_positions[i];
        dude_vs_normals[i] = u_lighting_transforms.shadow_view * dude_ms_normals[i];
    }
    ...
    for (int i = 0; i < 3; ++i) {
        ...
        ball_vs_positions[i] = u_lighting_transforms.shadow_view * ball_ms_positions[i];
        ball_vs_normals[i] = u_lighting_transforms.shadow_view * ball_ms_normals[i];
    }
    ...
    if (u_push_constant.progression > 0.0000001f) {
        ...
        for (int i = 0; i < 3; ++i) {
            ...
            vec3 previous_vs_position = dude_vs_positions[i].xyz;
            vec3 next_position = ball_vs_positions[i].xyz;
            ...
            gl_Position = u_lighting_transforms.shadow_projection * vec4(final_position, 1.0f);
        ...
        for (int i = 0; i < 3; ++i) {
            ...
            gl_Position = u_lighting_transforms.shadow_projection * dude_vs_positions[i];
